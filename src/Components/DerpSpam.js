...
const DerpAd = styled(Flex)`
	height: 60px;
	animation: ${colorMorph} .5s alternate infinite ease-in-out, ${crawlIn} 10s forwards;
	align-items: center;
	width: 75%;
	margin: auto;
	position: relative;
...
const DerpSpam = (props) => {
  return (
    <DerpAd is="a" href="http://derpfaces.net/">
      <Box p={1}><DerpIcon src="/images/coolglasses.png"/></Box>
      <Box p={1}><DerpIcon src="/images/bigbah.png"/></Box>	
      <Box p={1}><DerpIcon src="/images/thumbsup.png"/></Box>
      <DerpHeadline>{props.targetedMessage}</DerpHeadline>
      <Box p={1}><DerpIcon src="/images/winningsmile.png"/></Box>
      <Box p={1}><DerpIcon src="/images/wornout.png"/></Box>
